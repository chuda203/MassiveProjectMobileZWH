 ...
 * Use the [BerandaOrderSelesaiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BerandaOrderSelesaiFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
         ...
         * @return A new instance of fragment BerandaOrderSelesaiFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BerandaOrderSelesaiFragment().apply {
