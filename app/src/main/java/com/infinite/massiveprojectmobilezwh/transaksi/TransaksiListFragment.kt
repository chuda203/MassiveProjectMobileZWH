 ...
 * Use the [TransaksiListFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TransaksiListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_transaksi_list, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment TransaksiListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TransaksiListFragment().apply {
